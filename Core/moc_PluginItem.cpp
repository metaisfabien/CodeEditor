/****************************************************************************
** Meta object code from reading C++ file 'PluginItem.h'
**
...
#error "The header file 'PluginItem.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PluginItem_t, stringdata) + ofs \
...
const QMetaObject PluginItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PluginItem.data,
      qt_meta_data_PluginItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PluginItem.stringdata))
