...
# Generated by qmake (3.0) (Qt 5.1.1) on: jeu. janv. 23 12:24:26 2014
...
sub-ctags-qmake_all:  FORCE
	...
	cd ctags/ && $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile
	cd ctags/ && $(MAKE) -f Makefile qmake_all
sub-ctags: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
...
sub-ctags-all-ordered: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-ctags-all: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-ctags-clean-ordered: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-ctags-clean: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-ctags-distclean-ordered: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-ctags-distclean: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-ctags-install_subtargets-ordered: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-ctags-install_subtargets: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-ctags-uninstall_subtargets-ordered: FORCE
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-ctags-check_ordered:
	@test -d ctags/ || mkdir -p ctags/
	cd ctags/ && ( test -e Makefile || $(QMAKE) /home/fabien/Projects/CodeEditor/ctags/ctags.pro -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
